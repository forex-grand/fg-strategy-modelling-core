...
Environment Variables:
    ...
    S3_STORAGE_OPTION: Storage backend (default: 'cloudflare')
    S3_ENDPOINT: Cloudflare R2 endpoint URL
    S3_ACCESS_KEY: R2 access key ID
    S3_SECRET_KEY: R2 secret access key
    S3_REGION_NAME: R2 region (default: 'auto')
...
class Settings:
    ...
    Attributes:
        ...
        s3_storage_option: Storage backend. Cloudflare R2 is the supported default.
        s3_endpoint: URL endpoint for Cloudflare R2 storage
        s3_access_key: R2 access key ID
        s3_secret_key: R2 secret access key
        s3_region_name: R2 region name
    ...
    s3_storage_option: Optional[str] = field(
        default_factory=lambda: os.getenv("S3_STORAGE_OPTION", "cloudflare")
    )
    ...
    s3_region_name: Optional[str] = field(
        default_factory=lambda: os.getenv("S3_REGION_NAME", "auto")
    )
