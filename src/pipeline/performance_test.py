...
trade_managers = [
    ...
    {"type":"risk_reward", "params":{"rr_ratio":2.0,
    ...
    # ##TIME STOP BASED
    {"type":"time_stop", "params": {"max_duration_minutes":5}},
    {"type":"time_stop", "params": {"max_duration_minutes":15}},
    {"type":"time_stop", "params": {"max_duration_minutes":30}},
