...
class EnvironmentValidator:
    ...
    def validate_storage_config(storage_option: str) -> None:
        ...
        Args:
            storage_option: Storage backend type (minio, aws, gcs, cloudflare).
        ...
        if storage_option not in EnvironmentValidator.REQUIRED_FOR_STORAGE:
            ...
            raise EnvironmentError(
                ...
                f"Set S3_STORAGE_OPTION environment variable."
            )
        ...
        if missing:
            ...
            raise EnvironmentError(
                ...
                f"{missing_list}\n"
                f"Please set them before importing this package."
            )
...
def validate_environment_on_import() -> None:
    ...
    try:
        ...
        storage_option = os.getenv("S3_STORAGE_OPTION", "minio")
